import Language_bubble from "../components/FrameworksBubble"
...
function Profile() {
  return (
    <>
        ...
        <div className="bg-bg-black flex flex-col px-32 py-32 fade-animation">
            <h1 className="text-4xl mb-4 text-sexy-green font-bold">Profile</h1>

            <div className="w-full flex justify-between">

                <div className="flex flex-col w-[30%]">
                    <img className="mr-4 h-[300px] w-[300px] object-cover rounded-[5px]" src="pfp.png" alt="" />
                ...
                <div className="flex flex-col w-[70%] border border-white-strokes rounded-[5px] p-8">
                    <div className="flex justify-between h-[300px] mb-2">
                        <div className="w-[49%] rounded-[5px] flex flex-col items-center justify-center border border-white-strokes">
